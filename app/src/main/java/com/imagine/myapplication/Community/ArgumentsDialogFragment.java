    ...
    public void addArgumentButton(){
        if(!title.getText().toString().equals("") && !description.getText().toString().equals("")){
            if(auth.getCurrentUser() != null){
                ...
                Toast.makeText(getContext(),"Du musst eingeloggt sein um Argumente zu erstellen",
                        Toast.LENGTH_SHORT);
            }
        }else{
            Toast.makeText(getView().getContext()," NICE"
        ...
        docRef.set(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(mContext,"Argument wurde nicht hinzugefügt!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
